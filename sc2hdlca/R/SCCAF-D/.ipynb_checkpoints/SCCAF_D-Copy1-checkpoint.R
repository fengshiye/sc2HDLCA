...
SCCAF_D=function(bulk=bulk,reference=reference,transformation='none',deconv_type='sc',normalization_C='TMM',normalization_T='TMM',marker_strategy='all',method='DWLS',number_cells=10000,to_remove='none',num_cores=1,NormTrans=TRUE,return_expr=FALSE,batch_key='sampleID',span=0.3,python_home = Sys.which("python")) {
    ...
    source("/home/ubuntu/data/fengshuo/project/devlung_2025-10-30/SCCAF-D/benchmark1.R")
    source("/home/ubuntu/data/fengshuo/project/devlung_2025-10-30/SCCAF-D/deconvolution1.R")
    source("/home/ubuntu/data/fengshuo/project/devlung_2025-10-30/SCCAF-D/Frame.R")
    source("/home/ubuntu/data/fengshuo/project/devlung_2025-10-30/SCCAF-D/DWLS.R")
    source("/home/ubuntu/data/fengshuo/project/devlung_2025-10-30/SCCAF-D/expr.R")
    #####
    ...
    reticulate::source_python("/home/ubuntu/data/fengshuo/project/devlung_2025-10-30/SCCAF-D/scanpy_workflow.py")
    #####
    pathway=getwd()
    ####
